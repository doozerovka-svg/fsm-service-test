...
const filePath = "C:/Users/user/.gemini/antigravity/scratch/fsm-service-test/www/index.html";
...
for (const line of lines) {
    if (!injected && line.includes("<!-- Модальное окно: Выполнение ТО -->")) {
        outLines.push(newModal);
        injected = true;
    }
    outLines.push(line);
}
